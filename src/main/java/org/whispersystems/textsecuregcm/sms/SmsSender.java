...
public class SmsSender {
  ...
  static final String SMS_IOS_VERIFICATION_TEXT = "Your Cable verification code: %s\n\nOr tap: sgnl://verify/%s";
  static final String SMS_VERIFICATION_TEXT     = "Your Cable verification code: %s";
  static final String VOX_VERIFICATION_TEXT     = "Your Cable verification code is: ";
